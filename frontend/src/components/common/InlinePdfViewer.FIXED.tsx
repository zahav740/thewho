 ...
 * @description: ИСПРАВЛЕННЫЙ встроенный просмотрщик PDF с поддержкой новой системы организации файлов
 * @created: 2025-06-21
 * @updated: 2025-07-07 - Исправлены проблемы с localhost и добавлена поддержка новых URL
 */
