/**
 * @file: SimpleExcelImportDemo.tsx
 * @description: Простая демо-страница для тестирования импорта Excel с выбором колонок
 * @dependencies: antd, react, AdvancedExcelUploader
 * @created: 2025-06-25
 */
import React from 'react';
import { Card, Typography, Divider, Alert, Row, Col, Steps } from 'antd';
import { FileExcelOutlined, SettingOutlined, CheckCircleOutlined, ExperimentOutlined } from '@ant-design/icons';
import AdvancedExcelUploader from '../components/ExcelUploader/AdvancedExcelUploader';

const { Title, Paragraph, Text } = Typography;
const { Step } = Steps;

const SimpleExcelImportDemo: React.FC = () => {
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      <Card>
        <Title level={2}>
          <ExperimentOutlined /> Тестирование импорта Excel с выбором колонок
        </Title>
        ...
        <Steps size="small" style={{ marginBottom: 32 }}>
          ...
          <Step 
            ...
            description="Выберите соответствие" 
        ...
        <Divider orientation="left">🧪 Демо-версия (безопасное тестирование)</Divider>
          ...
          <Col span={8}>
            <Card title="1️⃣ Подготовка файла" size="small">
              <Paragraph style={{ fontSize: 12 }}>
                Создайте Excel файл с данными заказов:
                <br />• <Text code>A: Номер чертежа</Text>
                <br />• <Text code>B: Количество</Text>
                <br />• <Text code>C: Срок выполнения</Text>
                <br />• <Text code>D: Приоритет</Text>
                <br />• <Text code>E: Тип работы</Text>
                <br />• <Text code>F-I: Операции</Text>
              </Paragraph>
            </Card>
          </Col>
          
          <Col span={8}>
            <Card title="2️⃣ Процесс импорта" size="small">
              <Paragraph style={{ fontSize: 12 }}>
                Следуйте шагам мастера:
                <br />• Выберите лист для импорта
                <br />• Настройте соответствие колонок
                <br />• Проверьте настройки
                <br />• Запустите импорт
              </Paragraph>
            </Card>
          </Col>
          ...
          <Col span={8}>
            <Card title="3️⃣ Проверка результатов" size="small">
              <Paragraph style={{ fontSize: 12 }}>
                ...
                <br />• Количество созданных заказов
                <br />• Правильность маппинга данных
                <br />• Обработку ошибок
                <br />• Статистику импорта
              </Paragraph>
            </Card>
          </Col>
        </Row>
...
export default SimpleExcelImportDemo;
